      ...
      <Modal open={openModalLogin} onCancel={() => dispatch(setOpenModalLogin(false))} footer=''>
        <div className='p-10'>
          <Flex vertical gap={20}>
            <h1 className='font-mono text-[24px] font-bold'>Wecome to</h1>
            <Flex justify='space-around'>
              ...
              <button className='flex justify-center items-center gap-2 font-bold'>
                ...
                <span>Signin with FB</span>
              </button>
            </Flex>
            <Flex justify='center' align='center' gap={20}>
              <div className='border-b-[1px] flex-1' />
              <span>of signin with</span>
              <div className='border-b-[1px] flex-1' />
            </Flex>
            <Form form={form} name='basic' onFinish={onSignin}>
              <div>
                <label htmlFor='email' className='font-bold block mb-[0.5rem]'>
                  Email
                </label>
              ...
              <div>
                <label htmlFor='password' className='font-bold block mb-[0.5rem]'>
                  Password
                </label>
                <Form.Item<FieldType>
                  name='password'
